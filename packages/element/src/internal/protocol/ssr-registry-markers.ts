 ...
 *
 * The Router SSR/dev toolchain replaces `globalThis.customElements`
 ...
 * is written ONLY by Router tooling (SSR polyfill + generated entry code) and
 ...
 * Router tooling's generated entry code (entry-orchestrator.ts): a route
 ...
 * Router tooling's generated entry code (entry-orchestrator.ts).
 */
