...
export const PACKAGE_VERSION = '0.44.0-beta.2.2';
...
export const LATEST_LANDED_TRAIN = 'v0.44.0-beta.2.2';
export const ACTIVE_EXECUTION_VERSION = 'v0.44.0-beta.2.2';
export const NEXT_EXECUTION_VERSION = 'v0.44.0-beta.2.3';
...
export const NEXT_PUBLIC_PRERELEASE = 'v0.44.0-beta.2.3';
...
export const PREVIOUS_PACKAGE_VERSION = '0.44.0-beta.2.1';
