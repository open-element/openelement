...
const openElementPlugins = openElement({
  ...
  // The site's generated data modules (www/app/data/_generated-*) are checked
  // in and consumed as ordinary modules. Article collections and the blog
  // module are regenerated by `deno task generate:www-content-data` from
  // www/lib/content.ts + www/lib/blog.ts.
  i18n: {
    locales: ['en', 'zh'],
    defaultLocale: 'en',
  },
