// Auto-generated by www/tools/generate-site-article-routes.ts for www/content/docs/guide/streaming.md - do not edit.
import { element, OpenElement, property } from '@openelement/element';
import '../../site-ui/open-article-view.tsx';
import type { ArticlePageModel } from '../../site-ui/article-page-model.ts';

@element('guide-streaming')
export default class GuideStreamingPage extends OpenElement {
