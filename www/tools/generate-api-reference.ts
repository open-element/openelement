...
export function renderApiReferenceModule(build: ApiReferenceBuild): string {
  ...
  return '// Auto-generated by tools/generate-api-reference.ts (#1158) — do not edit\n' +
    ...
    '// packages/ui/src/generated-manifest.json. Regenerate with\n' +
    '// `deno task --cwd tools/repo generate:api-reference`; the file is untracked\n' +
    '// and rebuilt before test/site:build.\n' +
...
if (import.meta.main) {
  ...
  if (check) {
    ...
    if (existing !== module) {
      console.error(
        `${API_REFERENCE_ARTIFACT} is stale; run deno task --cwd tools/repo generate:api-reference`,
      );
      Deno.exit(1);
    }
